...
const createOrder = async (req, res) => {
    ...
    try {
        ...
        const sqlUpdate = 'UPDATE products SET quantity = quantity - ? WHERE id = ? AND quantity >= ?'
        ...
        const sqlInsert = 'INSERT INTO orders (user_id, product_id, quantity) VALUES (?, ?, ?)';
        ...
        res.status(400).json({ error: error.message || 'เกิดข้อผิดพลาดในการสั่งซื้อ' });
